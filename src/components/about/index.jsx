  ...
  return (
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full">
        ...
        <SectionTransition variant="slideUp" delay={0.2}>
          <ItemLayout
        ...
        <SectionTransition variant="slideUp" delay={0.3}>
          <ItemLayout
            className={"col-span-full xs:col-span-6 lg:col-span-4 text-accent"}
          >
            <p className="font-semibold w-full text-left text-2xl sm:text-5xl">
        ...
        <SectionTransition variant="slideUp" delay={0.4}>
        ...
        <SectionTransition variant="slideUp" delay={0.6}>
        ...
        <SectionTransition variant="slideUp" delay={0.8}>
          <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
            <Link
              href="https://github.com/aasurjya"
              target="_blank"
              className="w-full"
            >
              <img
